    ...
    <div className="min-h-screen bg-[#020617] text-white">
      ...
      <section className="pt-40 pb-24 px-6 md:px-10 max-w-[1200px] mx-auto">
        ...
        <h1 className="text-4xl md:text-6xl font-bold leading-tight mb-6">
          Vendor and platform decisions, made without the sales pitch.
        </h1>
        <p className="text-gray-400 text-lg max-w-2xl">
          Independent technology evaluation and platform selection guidance
          built around your actual constraints, not a vendor's roadmap.
        </p>
      </section>
    </div>
  );
