...
const CHALLENGES = [
  {
    ...
    desc: "Manual and inconsistent workflows reduce productivity, increase costs, and slow business operations.",
  },
  {
    icon: ShieldAlert,
    title: "Operational Bottlenecks",
    desc: "Poorly optimized processes create delays, impact service quality, and limit organizational performance.",
  },
  {
    icon: GitBranch,
    title: "Lack of Process Standardization",
    desc: "Inconsistent procedures across departments lead to inefficiencies and reduced collaboration.",
  },
  {
    icon: Database,
    title: "Limited Process Visibility",
    desc: "Without real-time process insights, organizations struggle to identify improvement opportunities and performance gaps.",
  },
  {
    icon: Repeat,
    title: "Continuous Improvement Challenges",
    desc: "Sustaining operational excellence requires ongoing process evaluation, optimization, and innovation.",
  },
  {
    icon: Eye,
    title: "Quality & Compliance Risks",
    desc: "Inefficient processes increase operational risks, compliance issues, and customer dissatisfaction.",
  },
];
...
const DELIVERABLES = [
  {
    ...
    desc: "Improve operational efficiency through process redesign, automation, and workflow optimization.",
  },
  {
    icon: Workflow,
    title: "Workflow Standardization",
    desc: "Create standardized business processes that improve collaboration, consistency, and operational quality.",
  },
  {
    icon: Database,
    title: "Process Analytics",
    desc: "Measure operational performance with real-time dashboards, KPIs, and process intelligence.",
  },
  {
    icon: ShieldCheck,
    title: "Governance & Compliance",
    desc: "Strengthen process governance while ensuring regulatory compliance and quality management.",
  },
  {
    icon: Eye,
    title: "Continuous Improvement",
    desc: "Establish continuous improvement programs that enhance productivity, quality, and business agility.",
  },
  {
    icon: MessageSquare,
    title: "Operational Excellence Consulting",
    desc: "Receive expert consulting to optimize business operations and build a culture of continuous improvement.",
  },
];

const FAQS = [
  {
    q: "What is Process Excellence?",
    a: "Process Excellence focuses on continuously improving business processes to increase efficiency, quality, productivity, and customer satisfaction.",
  },
  {
    q: "Why is Process Excellence important?",
    a: "It helps organizations reduce operational costs, improve quality, eliminate inefficiencies, and strengthen overall business performance.",
  },
  {
    q: "Can Process Excellence support digital transformation?",
    a: "Yes. Optimized business processes provide the foundation for successful automation and digital transformation initiatives.",
  },
  {
    q: "How do you measure process improvements?",
    a: "We use KPIs, process analytics, operational metrics, and performance dashboards to measure business outcomes and continuous improvement.",
  },
  {
    q: "Do you provide ongoing optimization services?",
    a: "Yes. We continuously monitor, evaluate, and optimize business processes to ensure long-term operational excellence.",
  },
];
/* ---------------------------------------------------------- */
/* Page                                                         */
...
>
  Optimize business performance through Process Excellence.
</motion.h1>
...
>
  Improve operational efficiency with Process Excellence services that streamline workflows, enhance quality, reduce costs, and drive continuous business improvement.
</motion.p>
...
>
  Schedule a Process Excellence Consultation
  <ArrowRight className="h-4 w-4 transition-transform group-hover:translate-x-1" />
      ...
      <section className="py-28 px-6 md:px-10 bg-white">
        <div className="max-w-[1400px] mx-auto grid md:grid-cols-2 gap-16 items-center">
          ...
          >
<Eyebrow>WHY PROCESS EXCELLENCE</Eyebrow>

<h2 className="text-3xl md:text-5xl font leading-[1.1] mb-8 tracking-tight text-[#0B1120]">
  Operational excellence begins with optimized processes.
</h2>

<div className="text-gray-600 text-lg leading-relaxed space-y-5">
  <p>
    Organizations achieve sustainable growth by continuously improving business processes, eliminating inefficiencies, and creating standardized workflows that increase productivity and service quality.
  </p>

  <p>
    Our Process Excellence services help businesses optimize operations, improve performance, strengthen governance, and establish a culture of continuous improvement across the enterprise.
  </p>
</div>
          </motion.div>
...
<p className="text-sm uppercase tracking-[0.35em] text-blue-500 font-semibold mb-4">
  Process Excellence Challenges
</p>

<h2 className="text-5xl md:text-6xl text-white font-light leading-tight max-w-6xl">
  The operational challenges that impact business efficiency and growth.
</h2>
          </motion.div>
...
<h2 className="text-5xl font-light text-slate-900 max-w-4xl mb-20 leading-tight">
  A structured framework for continuous operational improvement.
</h2>
...
<h2 className="mt-5 text-5xl font-light leading-tight text-white">
  Comprehensive Process Excellence services for high-performing organizations.
</h2>

<p className="mt-8 text-lg leading-8 text-white/60">
  Our Process Excellence services improve efficiency, standardize workflows, optimize operations, and create sustainable business value through continuous improvement.
</p>
                   </div>
...
<p className="mt-8 text-lg leading-8 text-white/60">
  Partner with our experts to streamline processes, improve business performance, and create sustainable operational excellence across your organization.
</p>
