...
const CHALLENGES = [
  {
    icon: Bot,
    title: "Complex Multi-Cloud Environments",
    desc: "Managing workloads across multiple cloud platforms increases operational complexity and administrative overhead.",
  },
  {
    icon: ShieldAlert,
    title: "Cloud Security Risks",
    desc: "Misconfigured cloud resources and inadequate security controls expose organizations to cyber threats and data breaches.",
  },
  {
    icon: GitBranch,
    title: "Resource & Cost Optimization",
    desc: "Without proper governance, cloud resources can become underutilized, leading to unnecessary operational costs.",
  },
  {
    icon: Database,
    title: "Performance & Availability",
    desc: "Maintaining high availability and consistent performance across cloud environments requires continuous monitoring.",
  },
  {
    icon: Repeat,
    title: "Scalability Challenges",
    desc: "Rapid business growth demands flexible cloud infrastructure that can scale efficiently without service disruption.",
  },
  {
    icon: Eye,
    title: "Limited Cloud Visibility",
    desc: "Organizations often lack centralized insights into cloud performance, resource utilization, and operational health.",
  },
];
...
const DELIVERABLES = [
  {
    ...
    desc: "Continuously monitor cloud infrastructure, workloads, and services to ensure maximum availability and performance.",
  },
  {
    icon: Workflow,
    title: "Cloud Operations Management",
    desc: "Manage cloud resources, automate routine operations, and optimize infrastructure for business efficiency.",
  },
  {
    icon: Database,
    title: "Backup & Disaster Recovery",
    desc: "Protect critical business data with secure backup solutions and reliable disaster recovery planning.",
  },
  {
    icon: ShieldCheck,
    title: "Cloud Security & Compliance",
    desc: "Secure cloud environments through identity management, threat protection, governance, and compliance controls.",
  },
  {
    icon: Eye,
    title: "Performance & Cost Optimization",
    desc: "Optimize cloud performance while reducing infrastructure costs through continuous analysis and resource management.",
  },
  {
    icon: MessageSquare,
    title: "Cloud Support & Consulting",
    desc: "Receive expert guidance, ongoing technical support, cloud optimization, and strategic advisory services.",
  },
];
...
const FAQS = [
  {
    ...
    a: "Managed Cloud Services provide continuous monitoring, maintenance, optimization, security, and operational management for cloud infrastructure and applications.",
  },
  {
    q: "Why should businesses use Managed Cloud Services?",
    a: "They improve cloud performance, strengthen security, reduce operational complexity, optimize costs, and ensure business continuity.",
  },
  {
    q: "Which cloud platforms do you support?",
    a: "We support major cloud platforms including Microsoft Azure, Amazon Web Services (AWS), Google Cloud Platform (GCP), and hybrid cloud environments.",
  },
  {
    q: "Do you provide 24/7 cloud monitoring?",
    a: "Yes. Our Managed Cloud Services include continuous monitoring, incident management, performance optimization, and proactive support.",
  },
  {
    q: "Can you help optimize cloud costs?",
    a: "Absolutely. We continuously analyze cloud resource usage, eliminate waste, optimize workloads, and recommend cost-effective cloud strategies.",
  },
];
/* ---------------------------------------------------------- */
/* Page                                                         */
...
const AIAgents = () => {
  ...
  animate="visible"
  custom={0}
  className="text-[10px] sm:text-xs font-semibold uppercase tracking-[0.2em] sm:tracking-[0.3em] text-[#93A5FF] mb-4 sm:mb-6 font-['Montserrat']"
>
...
>
  Simplify cloud operations with intelligent Managed Cloud Services.
</motion.h1>
...
>
  Optimize, secure, and manage your cloud infrastructure with Managed Cloud Services that deliver continuous monitoring, cost optimization, performance management, and expert operational support.
</motion.p>
  ...
  <ArrowRight className="h-4 w-4 transition-transform group-hover:translate-x-1" />
      ...
      <section className="py-16 sm:py-20 md:py-28 px-5 sm:px-6 md:px-10 bg-white">
        <div className="max-w-[1400px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 sm:gap-12 md:gap-16 items-center">
          ...
          >
           <Eyebrow>WHY MANAGED CLOUD SERVICES</Eyebrow>

<h2 className="text-2xl sm:text-3xl md:text-5xl font leading-[1.15] sm:leading-[1.1] mb-6 sm:mb-8 tracking-tight text-[#0B1120]">
  Maximize cloud performance while reducing operational complexity.
</h2>

<div className="text-gray-600 text-base sm:text-lg leading-relaxed space-y-4 sm:space-y-5">
  <p>
    As cloud environments grow, managing infrastructure, security, performance,
    and costs becomes increasingly complex. Organizations need continuous
    visibility and expert management to keep cloud operations efficient and
    secure.
  </p>

  <p>
    Our Managed Cloud Services provide proactive monitoring, infrastructure
    optimization, security management, and ongoing support to ensure your cloud
    environment remains resilient, scalable, and cost-effective.
  </p>
</div>
          </motion.div>
...
<h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl text-white font-light leading-tight max-w-6xl">
  The cloud management challenges that impact business agility.
</h2>
          </motion.div>
...
<h2 className="text-3xl sm:text-4xl md:text-5xl font-light text-slate-900 max-w-4xl mb-12 sm:mb-16 md:mb-20 leading-tight">
  A proactive approach to managing modern cloud environments.
</h2>
  ...
  Comprehensive Managed Cloud Services for modern enterprises.
</h2>

<p className="mt-6 sm:mt-8 text-base sm:text-lg leading-7 sm:leading-8 text-white/60">
  Our Managed Cloud Services deliver secure, scalable, and optimized cloud
  operations through continuous monitoring, proactive management, and expert
  cloud support.
</p>
      ...
      <section className="relative py-20 sm:py-28 md:py-40 px-5 sm:px-6 md:px-10 overflow-hidden">
        ...
        >
        <h2 className="mt-5 text-3xl sm:text-4xl md:text-5xl font-light leading-tight text-white">
  Unlock the full potential of your cloud investment.
</h2>

<p className="mt-6 sm:mt-8 text-base sm:text-lg leading-7 sm:leading-8 text-white/60">
  Empower your business with Managed Cloud Services that improve performance,
  strengthen security, optimize costs, and ensure reliable cloud operations at
