...
const CHALLENGES = [
  {
    ...
    desc: "Business data is often scattered across multiple systems, making it difficult to generate unified and actionable insights.",
  },
  {
    icon: ShieldAlert,
    title: "Poor Data Quality",
    desc: "Incomplete, inconsistent, or outdated data reduces the accuracy of AI-driven analytics and business decisions.",
  },
  {
    icon: GitBranch,
    title: "Limited Predictive Insights",
    desc: "Traditional reporting focuses on historical data, limiting the ability to anticipate future business trends and opportunities.",
  },
  {
    icon: Database,
    title: "Scalability Challenges",
    desc: "Growing volumes of structured and unstructured data require scalable analytics platforms and AI capabilities.",
  },
  {
    icon: Repeat,
    title: "Slow Decision-Making",
    desc: "Manual reporting and delayed insights prevent organizations from responding quickly to changing business conditions.",
  },
  {
    icon: Eye,
    title: "Limited Business Visibility",
    desc: "Without real-time analytics, organizations struggle to monitor performance, identify risks, and optimize operations.",
  },
];
...
const DELIVERABLES = [
  {
    ...
    desc: "Leverage AI models to forecast business trends, customer behavior, and operational outcomes.",
  },
  {
    icon: Workflow,
    title: "Business Intelligence Dashboards",
    desc: "Visualize key business metrics through interactive dashboards and real-time reporting.",
  },
  {
    icon: Database,
    title: "Data Integration & Management",
    desc: "Unify enterprise data from multiple sources to create a reliable analytics foundation.",
  },
  {
    icon: ShieldCheck,
    title: "AI-Powered Decision Support",
    desc: "Enable faster, data-driven business decisions with intelligent recommendations and insights.",
  },
  {
    icon: Eye,
    title: "Performance Analytics",
    desc: "Monitor KPIs, operational efficiency, and business performance with real-time AI analytics.",
  },
  {
    icon: MessageSquare,
    title: "Analytics Consulting",
    desc: "Receive expert guidance to develop AI analytics strategies that support long-term business growth.",
  },
];
...
const FAQS = [
  {
    ...
    a: "AI Analytics combines artificial intelligence, machine learning, and advanced analytics to generate actionable business insights and improve decision-making.",
  },
  {
    q: "Why is AI Analytics important?",
    a: "It helps organizations uncover hidden patterns, predict future outcomes, automate reporting, and make faster, data-driven decisions.",
  },
  {
    q: "Can AI Analytics integrate with existing business systems?",
    a: "Yes. AI Analytics solutions integrate with ERP, CRM, cloud platforms, databases, and other enterprise applications.",
  },
  {
    q: "Do you provide real-time analytics dashboards?",
    a: "Yes. We build interactive dashboards that provide real-time visibility into business performance and operational KPIs.",
  },
  {
    q: "Can AI Analytics support predictive business planning?",
    a: "Absolutely. Our AI models forecast trends, identify opportunities, and help organizations make proactive strategic decisions.",
  },
];
/* ---------------------------------------------------------- */
/* Page                                                         */
...
>
  Unlock smarter business decisions with AI Analytics.
</motion.h1>
...
>
  Transform enterprise data into actionable insights with AI Analytics that delivers predictive intelligence, real-time dashboards, and data-driven decision support.
</motion.p>
...
>
  Schedule an AI Analytics Consultation
  <ArrowRight className="h-4 w-4 transition-transform group-hover:translate-x-1" />
      ...
      <section className="py-16 sm:py-20 md:py-28 px-5 sm:px-6 md:px-10 bg-white">
        <div className="max-w-[1400px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 sm:gap-12 md:gap-16 items-center">
          ...
          >
<Eyebrow>WHY AI ANALYTICS</Eyebrow>

<h2 className="text-2xl sm:text-3xl md:text-5xl font leading-[1.15] sm:leading-[1.1] mb-6 sm:mb-8 tracking-tight text-[#0B1120]">
  Turn enterprise data into strategic business intelligence.
</h2>

<div className="text-gray-600 text-base sm:text-lg leading-relaxed space-y-4 sm:space-y-5">
  <p>
    Organizations generate massive volumes of data every day, but extracting meaningful insights requires advanced analytics, automation, and intelligent decision support.
  </p>

  <p>
    Our AI Analytics services help businesses unify data, uncover hidden opportunities, predict future trends, and make faster, more confident decisions through AI-powered intelligence.
  </p>
</div>
          </motion.div>
...
<h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl text-white font-light leading-tight max-w-6xl">
  The data and analytics challenges that limit business growth.
</h2>
          </motion.div>
...
<h2 className="text-3xl sm:text-4xl md:text-5xl font-light text-slate-900 max-w-4xl mb-12 sm:mb-16 md:mb-20 leading-tight">
  A strategic framework for intelligent business analytics.
</h2>
...
<h2 className="mt-4 sm:mt-5 text-3xl sm:text-4xl md:text-5xl font-light leading-tight text-white">
  Comprehensive AI Analytics solutions for data-driven enterprises.
</h2>

<p className="mt-6 sm:mt-8 text-base sm:text-lg leading-7 sm:leading-8 text-white/60">
  Our AI Analytics services empower organizations with predictive intelligence, real-time insights, and advanced analytics that improve operational performance and strategic decision-making.
</p>
                   </div>
...
<p className="mt-6 sm:mt-8 text-base sm:text-lg leading-7 sm:leading-8 text-white/60">
  Partner with our AI Analytics experts to unlock actionable insights, accelerate innovation, and drive smarter business decisions through intelligent analytics.
</p>
