...
const CHALLENGES = [
  {
    ...
    desc: "Enterprise data is distributed across multiple systems, making integration and unified analytics difficult.",
  },
  {
    icon: ShieldAlert,
    title: "Poor Data Quality",
    desc: "Inconsistent, incomplete, and duplicate data reduces the accuracy of reporting, analytics, and AI initiatives.",
  },
  {
    icon: GitBranch,
    title: "Scalable Data Pipeline Challenges",
    desc: "Building reliable data pipelines that process growing volumes of enterprise data requires specialized expertise.",
  },
  {
    icon: Database,
    title: "Legacy Data Infrastructure",
    desc: "Outdated data platforms limit scalability, performance, and the ability to support modern analytics workloads.",
  },
  {
    icon: Repeat,
    title: "Real-Time Data Processing",
    desc: "Organizations struggle to capture, process, and analyze streaming data for timely business decisions.",
  },
  {
    icon: Eye,
    title: "Limited Data Governance",
    desc: "Without proper governance, organizations face challenges in maintaining data security, compliance, and consistency.",
  },
];
...
const FRAMEWORK = [
  {
    ...
    desc: "We evaluate your existing data landscape, business objectives, and infrastructure to define a scalable data engineering strategy.",
    image: "/DA&AI/35.avif",
  },
  {
    step: "02",
    title: "Architecture Design",
    desc: "Our experts design modern data architectures that support integration, scalability, governance, and analytics.",
    image: "/DA&AI/36.avif",
  },
  {
    step: "03",
    title: "Pipeline Development",
    desc: "We build secure, automated data pipelines that collect, transform, and deliver trusted enterprise data.",
    image: "/DA&AI/37.avif",
  },
  {
    step: "04",
    title: "Data Platform Deployment",
    desc: "Deploy cloud-native data platforms, warehouses, and lakes that enable real-time analytics and AI workloads.",
    image: "/DA&AI/38.avif",
  },
  {
    step: "05",
    title: "Optimization & Governance",
    desc: "Continuously improve data quality, performance, governance, and operational efficiency across the enterprise.",
    image: "/DA&AI/39.avif",
  },
];
...
const DELIVERABLES = [
  {
    ...
    desc: "Build scalable pipelines that automate data collection, transformation, and integration across business systems.",
  },
  {
    icon: Workflow,
    title: "Data Warehousing & Lakes",
    desc: "Design modern cloud data warehouses and data lakes that support enterprise analytics and AI initiatives.",
  },
  {
    icon: Database,
    title: "Data Integration",
    desc: "Unify structured and unstructured data from multiple enterprise applications into a centralized platform.",
  },
  {
    icon: ShieldCheck,
    title: "Data Governance & Security",
    desc: "Strengthen data quality, governance, compliance, and security across your enterprise data ecosystem.",
  },
  {
    icon: Eye,
    title: "Real-Time Data Processing",
    desc: "Enable streaming analytics and real-time business intelligence with high-performance data platforms.",
  },
  {
    icon: MessageSquare,
    title: "Data Engineering Consulting",
    desc: "Receive expert guidance to modernize your data infrastructure and maximize business value from enterprise data.",
  },
];
...
const FAQS = [
  {
    ...
    a: "Data Engineering focuses on designing, building, and maintaining scalable data infrastructure that supports analytics, AI, and business intelligence.",
  },
  {
    q: "Why is Data Engineering important?",
    a: "It enables organizations to manage enterprise data efficiently, improve data quality, support real-time analytics, and accelerate digital transformation.",
  },
  {
    q: "Can you modernize existing data platforms?",
    a: "Yes. We modernize legacy data infrastructure by implementing cloud-native data platforms, automated pipelines, and scalable architectures.",
  },
  {
    q: "Do you support cloud-based data engineering?",
    a: "Absolutely. We build secure and scalable data solutions across AWS, Microsoft Azure, Google Cloud, and hybrid environments.",
  },
  {
    q: "Can Data Engineering support AI initiatives?",
    a: "Yes. Reliable data pipelines and high-quality enterprise data provide the foundation for successful AI, machine learning, and advanced analytics projects.",
  },
];
/* ---------------------------------------------------------- */
/* Page                                                         */
...
>
  Build a scalable data foundation with modern Data Engineering.
</motion.h1>
...
>
  Design intelligent data platforms, automate data pipelines, and enable trusted analytics with enterprise Data Engineering solutions that accelerate innovation and business growth.
</motion.p>
...
>
  <span className="min-w-0">Schedule a Data Engineering Consultation</span>
  <ArrowRight className="h-4 w-4 shrink-0 transition-transform group-hover:translate-x-1" />
      ...
      <section className="py-14 sm:py-20 md:py-28 px-4 sm:px-6 md:px-10 bg-white">
        <div className="max-w-[1400px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 sm:gap-12 md:gap-16 items-center">
          ...
          >
<Eyebrow>WHY DATA ENGINEERING</Eyebrow>

<h2 className="text-2xl sm:text-3xl md:text-5xl font leading-[1.15] sm:leading-[1.1] mb-6 sm:mb-8 tracking-tight text-[#0B1120]">
  Build trusted data foundations for intelligent business decisions.
</h2>

<div className="text-gray-600 text-base sm:text-lg leading-relaxed space-y-4 sm:space-y-5">
  <p>
    Modern organizations depend on reliable, scalable, and well-governed data to power analytics, artificial intelligence, and digital transformation initiatives.
  </p>

  <p>
    Our Data Engineering services help businesses integrate enterprise data, modernize infrastructure, automate pipelines, and create high-performance platforms that deliver accurate insights and long-term business value.
  </p>
</div>
...
<h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl text-white font-light leading-tight max-w-6xl">
  The data infrastructure challenges limiting analytics and business innovation.
</h2>
          </motion.div>
...
<h2 className="text-3xl sm:text-4xl md:text-5xl font-light text-slate-900 max-w-4xl mb-10 sm:mb-14 md:mb-20 leading-tight">
  A modern framework for building scalable and intelligent data platforms.
</h2>
...
<p className="mt-4 sm:mt-6 md:mt-8 text-base sm:text-lg leading-7 sm:leading-8 text-white/60">
  Our Data Engineering services help organizations build scalable data platforms, automate data pipelines, improve governance, and unlock the full value of enterprise data.
</p>
                   </div>
      ...
      <section className="relative py-20 sm:py-28 md:py-40 px-4 sm:px-6 md:px-10 overflow-hidden">
        ...
        >
<h2 className="mt-2 sm:mt-3 md:mt-5 text-3xl sm:text-4xl md:text-5xl font-light leading-tight text-white">
  Build the data foundation for tomorrow's innovation.
</h2>

<p className="mt-4 sm:mt-6 md:mt-8 text-base sm:text-lg leading-7 sm:leading-8 text-white/60">
  Partner with our Data Engineering experts to modernize your data infrastructure, accelerate analytics, and power AI-driven business transformation.
</p>
