...
const CHALLENGES = [
  {
    ...
    desc: "Manual accounting and reporting increase administrative effort, delays, and the risk of costly errors.",
  },
  {
    icon: ShieldAlert,
    title: "Disconnected Financial Systems",
    desc: "Multiple financial applications create inconsistent data and reduce operational visibility.",
  },
  {
    icon: GitBranch,
    title: "Limited Financial Visibility",
    desc: "Without real-time reporting, leadership struggles to monitor cash flow, profitability, and financial performance.",
  },
  {
    icon: Database,
    title: "Budgeting & Forecasting Challenges",
    desc: "Traditional budgeting methods make it difficult to adapt quickly to changing business conditions.",
  },
  {
    icon: Repeat,
    title: "Regulatory Compliance Risks",
    desc: "Managing financial regulations and audit requirements manually increases compliance challenges.",
  },
  {
    icon: Eye,
    title: "Inefficient Decision Making",
    desc: "Limited financial insights prevent organizations from making timely and informed strategic decisions.",
  },
];
...
const DELIVERABLES = [
  ...
  
  {
    ...
    desc: "Plan budgets, forecast financial performance, and monitor business objectives with confidence.",
  },
  {
    icon: Database,
    title: "Financial Reporting",
    desc: "Generate real-time financial reports, dashboards, and executive insights for informed decision-making.",
  },
  {
    icon: ShieldCheck,
    title: "Compliance & Risk Management",
    desc: "Maintain regulatory compliance, audit readiness, and secure financial governance.",
  },
  {
    icon: Eye,
    title: "Cash Flow Management",
    desc: "Monitor cash flow, optimize working capital, and improve financial planning across the organization.",
  },
  {
    icon: MessageSquare,
    title: "Finance Integration & Support",
    desc: "Integrate finance platforms with enterprise systems while providing continuous support and optimization.",
  },
];

const FAQS = [
  {
    q: "What are Finance Solutions?",
    a: "Finance Solutions help organizations automate accounting, budgeting, reporting, compliance, and financial planning through integrated digital platforms.",
  },
  {
    q: "How do Finance Solutions improve business performance?",
    a: "They provide real-time financial visibility, automate repetitive tasks, improve reporting accuracy, and support faster strategic decision-making.",
  },
  {
    q: "Can Finance Solutions integrate with our ERP and banking systems?",
    a: "Yes. Our finance solutions integrate seamlessly with ERP platforms, payroll systems, banking applications, tax platforms, and other enterprise software.",
  },
  {
    q: "Are Finance Solutions suitable for growing businesses?",
    a: "Absolutely. Our scalable finance solutions support organizations of all sizes and adapt to evolving business requirements.",
  },
  {
    q: "Do you provide implementation and ongoing support?",
    a: "Yes. We provide consulting, implementation, integration, user training, maintenance, and continuous optimization services.",
  },
];
/* ---------------------------------------------------------- */
/* Page                                                         */
    ...
    <div className="min-h-screen bg-white text-[#0B1120]">
      ...
      <section className="relative h-screen min-h-[720px] w-full overflow-hidden flex items-end">
        ...
        <div className="relative z-10 max-w-[1400px] mx-auto w-full px-6 md:px-10 pb-24 pt-40">
          ...
          >
           Transform financial operations with intelligent finance solutions.
          </motion.h1>
          <motion.p
            variants={fadeUp}
            initial="hidden"
          ...
          >
            We help organizations modernize financial management through integrated solutions that streamline accounting, budgeting, reporting, compliance, and financial planning for sustainable business growth.
          </motion.p>
          <motion.div variants={fadeUp} initial="hidden" animate="visible" custom={0.32}>
            ...
            >
              Schedule a Finance Consultation
      ...
      <section className="py-28 px-6 md:px-10 bg-white">
        <div className="max-w-[1400px] mx-auto grid md:grid-cols-2 gap-16 items-center">
          ...
          >
            <Eyebrow>WHY FINANCE SOLUTIONS</Eyebrow>
            <h2 className="text-3xl md:text-5xl font leading-[1.1] mb-8 tracking-tight text-[#0B1120]">
              Financial clarity drives confident business decisions.
            </h2>
            <div className="text-gray-600 text-lg leading-relaxed space-y-5">
              <p>
                Many organizations rely on disconnected financial systems and manual accounting processes, leading to reporting delays, compliance risks, and limited visibility into business performance.
              </p>
              <p>
                Our Finance Solutions centralize financial operations, automate accounting workflows, improve reporting accuracy, and provide real-time insights that enable faster, data-driven decision-making.
              </p>
            </div>
          </motion.div>
        ...
        <div className="max-w-[1400px] mx-auto">
          ...
          >
            ...
            <h2 className="text-5xl md:text-6xl text-white font-light leading-tight max-w-6xl">
              The financial challenges that impact business performance.
            </h2>
          </motion.div>
      ...
      <section className="bg-white py-28">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <h2 className="text-5xl font-light text-slate-900 max-w-4xl mb-20 leading-tight">
           A structured approach to modernizing financial operations.
          </h2>
          ...
          <div className="grid lg:grid-cols-[420px_1fr] gap-20">
            ...
            <div className="lg:sticky lg:top-28 self-start">
              ...
              <h2 className="mt-5 text-5xl font-light leading-tight text-white">
                Comprehensive finance solutions for modern enterprises.
              </h2>
      
              <p className="mt-8 text-lg leading-8 text-white/60">
               Our Finance Solutions improve financial accuracy, streamline operations, strengthen compliance, and provide actionable insights for better business performance.
              </p>
      ...
      <section className="relative py-40 px-6 md:px-10 overflow-hidden">
        ...
        >
          <h2 className="text-4xl md:text-6xl font leading-[1.05] text-white mb-8 tracking-tight">
            Empower smarter financial decisions with intelligent finance solutions.
          </h2>
          <p className="text-white/70 text-lg max-w-2xl mx-auto mb-12 leading-relaxed">
           Transform your financial operations with integrated solutions that improve accuracy, strengthen compliance, optimize performance, and support sustainable business growth.
          </p>
          <Link
            to="/contact"
