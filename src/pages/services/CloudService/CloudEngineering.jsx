...
const CHALLENGES = [
  { icon: DollarSign, title: "Runaway cloud spend", desc: "Unoptimized infrastructure and idle resources quietly inflate cloud bills month over month." },
  { icon: ServerCog, title: "Infrastructure that doesn't scale", desc: "Systems built for yesterday's traffic buckle under real growth, causing outages at the worst moments." },
  { icon: Lock, title: "Security gaps across environments", desc: "Misconfigured access and inconsistent policy create exposure across sprawling cloud environments." },
  { icon: GitBranch, title: "Slow, manual deployments", desc: "Without automation, shipping changes safely takes days instead of minutes, and errors slip through." },
  { icon: Network, title: "Fragmented multi-cloud environments", desc: "Systems spread across providers with no unifying strategy create operational blind spots." },
  { icon: Eye, title: "No visibility into system health", desc: "Teams find out about outages from customers instead of from monitoring built to catch them first." },
];

const FRAMEWORK = [
  { step: "01", title: "Assess", desc: "We audit your current infrastructure, architecture, and cloud spend to identify risk, waste, and scaling limits.", image: "https://images.unsplash.com/photo-1451187580459-43490279c0fa?q=80&w=1600&auto=format&fit=crop" },
  { step: "02", title: "Architect", desc: "We design a target cloud architecture built for your actual scale, security, and reliability requirements.", image: "https://images.unsplash.com/photo-1544197150-b99a580bb7a8?q=80&w=1600&auto=format&fit=crop" },
  { step: "03", title: "Migrate & Build", desc: "We implement infrastructure as code, migrate workloads, and stand up the automation pipelines behind it.", image: "https://images.unsplash.com/photo-1558494949-ef010cbdcc31?q=80&w=1600&auto=format&fit=crop" },
  { step: "04", title: "Harden", desc: "We layer in security controls, access policy, and disaster recovery so the system holds up under real conditions.", image: "https://images.unsplash.com/photo-1573164713988-8665fc963095?q=80&w=1600&auto=format&fit=crop" },
  { step: "05", title: "Operate & Optimize", desc: "We monitor performance and spend continuously, tuning the environment as your workloads evolve.", image: "https://images.unsplash.com/photo-1518770660439-4636190af475?q=80&w=1600&auto=format&fit=crop" },
];

const DELIVERABLES = [
  { icon: Boxes, title: "Infrastructure as Code", desc: "Version-controlled, repeatable infrastructure that eliminates manual configuration drift." },
  { icon: ServerCog, title: "Cloud-Native Architecture", desc: "Systems designed to scale elastically with demand rather than fixed, over-provisioned capacity." },
  { icon: GitBranch, title: "CI/CD Pipelines", desc: "Automated build, test, and deployment pipelines that ship changes safely and fast." },
  { icon: ShieldCheck, title: "Security & Compliance Controls", desc: "Identity, access, and network policy built into the infrastructure from the ground up." },
  { icon: Gauge, title: "Observability & Monitoring", desc: "Real-time visibility into system health, performance, and cost across every environment." },
...
const FAQS = [
  ...
  { q: "How do you reduce cloud costs without hurting performance?", a: "We right-size infrastructure, eliminate idle resources, and rearchitect where autoscaling can replace fixed overprovisioning, so cost comes down without capacity coming down with it." },
  { q: "Can you migrate our infrastructure without downtime?", a: "Yes. We plan migrations in stages with rollback paths at each step, so production workloads keep running throughout the transition." },
  { q: "What does 'infrastructure as code' actually mean for our team?", a: "It means your infrastructure is defined in version-controlled files instead of manual console changes, so environments are consistent, reproducible, and easy to review before they change." },
  { q: "Do you provide ongoing support after the build is complete?", a: "Yes. We offer ongoing monitoring, optimization, and incident support so the environment keeps performing as your workloads and traffic evolve." },
];
...
const CloudEngineering = () => {
  ...
  return (
    <div className="min-h-screen bg-white text-[#0B1120]">
      ...
      <section className="relative h-screen min-h-[720px] w-full overflow-hidden flex items-end">
        ...
        >
          <img
            ...
            alt="Cloud infrastructure and engineering"
        ...
        <div className="relative z-10 max-w-[1400px] mx-auto w-full px-6 md:px-10 pb-24 pt-40">
          ...
          >
            Infrastructure that scales as fast as you do.
          </motion.h1>
          <motion.p
            variants={fadeUp}
            initial="hidden"
          ...
          >
            We design, build, and operate cloud infrastructure that handles
            real growth, ships changes safely, and holds up under load,
            without the manual overhead or runaway spend.
          </motion.p>
      ...
      {/* ============================================================ */}
      {/* WHY CLOUD ENGINEERING — split, floating cards                  */}
      {/* ============================================================ */}
      <section className="py-28 px-6 md:px-10 bg-white">
        <div className="max-w-[1400px] mx-auto grid md:grid-cols-2 gap-16 items-center">
          ...
          >
            <Eyebrow>Why Cloud Engineering</Eyebrow>
            <h2 className="text-3xl md:text-5xl font leading-[1.1] mb-8 tracking-tight text-[#0B1120]">
              Infrastructure you outgrow is a liability, not an asset.
            </h2>
            <div className="text-gray-600 text-lg leading-relaxed space-y-5">
              <p>
                Most infrastructure is built to solve today's problem. It
                works, until traffic spikes, a region goes down, or a
                deployment breaks something no one caught in time, and
                the gaps in the architecture become everyone's problem.
              </p>
              <p>
                Cloud engineering closes that gap in advance. It's
                infrastructure designed to scale elastically, deploy
                safely through automation, and stay visible through
                monitoring, so growth doesn't come with fragility built in.
              </p>
            </div>
          </motion.div>
      ...
      {/* ============================================================ */}
      {/* ENGINEERING FRAMEWORK — large stacked image cards              */}
      {/* ============================================================ */}
      ...
      <section className="relative py-40 px-6 md:px-10 overflow-hidden">
        ...
        >
          <h2 className="text-4xl md:text-6xl font leading-[1.05] text-white mb-8 tracking-tight">
            Give your team infrastructure that holds up under real load.
          </h2>
          <p className="text-white/70 text-lg max-w-2xl mx-auto mb-12 leading-relaxed">
            Our cloud engineers help you architect, migrate, and operate
            infrastructure built for the scale, security, and speed your
