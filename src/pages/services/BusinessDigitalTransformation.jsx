...
const CAPABILITIES = [
  {
    ...
    short:
      "Transformation roadmaps that connect digital investment to business outcomes.",
    image: "/art.jpg",
    tags: ["Consulting", "Roadmap", "Transformation"],
    link: "/services/BusinessDigitalTransformation/digital-strategy",
  },
  {
    id: 2,
    title: "Process Automation",
    short:
      "Re-engineer manual workflows into automated, auditable digital processes.",
    image: "/art.jpg",
    tags: ["Automation", "Workflow", "Efficiency"],
    link: "/services/BusinessDigitalTransformation/process-automation",
  },
  {
    id: 3,
    title: "Cloud Transformation",
    short:
      "Migrate and modernize core systems onto scalable cloud infrastructure.",
    image: "/art.jpg",
    tags: ["Cloud", "Migration", "Infrastructure"],
    link: "/services/BusinessDigitalTransformation/cloud-transformation",
  },
  {
    id: 4,
    title: "Customer Experience",
    short:
      "Digital products and platforms designed around the modern customer journey.",
    image: "/art.jpg",
    tags: ["UX", "Platforms", "Digital Product"],
    link: "/services/BusinessDigitalTransformation/customer-experience",
  },
  {
    id: 5,
    title: "Data Modernization",
    short:
      "Unify fragmented data sources into a single, trusted digital foundation.",
    image: "/art.jpg",
    tags: ["Data", "Architecture", "Analytics"],
    link: "/services/BusinessDigitalTransformation/data-modernization",
  },
  {
    id: 6,
    title: "Change Management",
    short:
      "Structured adoption programs that turn new systems into daily habits.",
    image: "/art.jpg",
    tags: ["Adoption", "Training", "Culture"],
    link: "/services/BusinessDigitalTransformation/change-management",
  },
];
...
const CHALLENGES = [
  {
    title: "Digital initiatives without a strategy",
    desc: "Individual departments adopt point solutions independently, leaving no coherent digital roadmap for the organization as a whole.",
  },
  {
    title: "Legacy systems resisting change",
    desc: "Core platforms built decades ago are too rigid to support new digital products, channels, or customer expectations.",
  },
  {
    title: "Automation stuck at the pilot stage",
    desc: "Process automation proofs-of-concept show promise but never scale beyond a single team due to unclear ownership.",
  },
  {
    title: "Customer experience lagging competitors",
    desc: "Digital touchpoints feel disconnected from the brand and from each other, driving customers toward more modern competitors.",
  },
  {
    title: "Data still living in silos",
    desc: "Sales, operations, and finance systems don't share a common data model, making enterprise-wide insight nearly impossible.",
  },
  {
    title: "Teams resisting new tools",
    desc: "Transformation programs stall post-launch because change management and training were treated as an afterthought.",
  },
];
...
const METHODOLOGY = [
  {
    step: "01",
    title: "Assess",
    desc: "We audit existing systems, workflows, and digital maturity to identify where transformation creates the most defensible business value.",
    image: "/art.jpg",
  },
  {
    step: "02",
    title: "Design",
    desc: "We architect the target operating model and technology stack, sequenced against organizational readiness and business priorities.",
    image: "/art.jpg",
  },
  {
    step: "03",
    title: "Build",
    desc: "Delivery teams develop, configure, and integrate digital solutions using agile delivery, with governance checkpoints in every sprint.",
    image: "/art.jpg",
  },
  {
    step: "04",
    title: "Deploy",
    desc: "Solutions move to production with monitoring, rollback plans, and adoption support in place from day one.",
    image: "/art.jpg",
  },
  {
    step: "05",
    title: "Scale & Govern",
    desc: "We establish ongoing optimization, training cycles, and governance reporting so transformation compounds as the business grows.",
    image: "/art.jpg",
  },
];
...
const INDUSTRIES = [
  {
    ...
    image: "/art.jpg",
    desc: "Digital onboarding, process automation, and modernized core banking workflows.",
  },
  {
    title: "Manufacturing",
    image: "/art.jpg",
    desc: "Connected factory systems, digital twins, and real-time supply chain visibility.",
  },
  {
    title: "Healthcare",
    image: "/art.jpg",
    desc: "Digital patient experience and compliance-aware operational modernization.",
  },
  {
    title: "Retail",
    image: "/art.jpg",
    desc: "Omnichannel commerce, personalization, and unified inventory systems.",
  },
  {
    title: "Logistics",
    image: "/art.jpg",
    desc: "Digital freight visibility, warehouse automation, and fleet modernization.",
  },
  {
    title: "Public Sector",
    image: "/art.jpg",
    desc: "Citizen-facing digital services and modernized back-office operations.",
  },
];
...
const FAQS = [
  {
    q: "How is Tec Tha's approach to digital transformation different from a generic consultancy?",
    a: "We do not hand over a slide deck and walk away. Every engagement pairs strategy with hands-on implementation, so the roadmap we design is the same one our teams build, deploy, and support.",
  },
  {
    q: "How long does a typical digital transformation engagement take?",
    a: "A focused process automation initiative can move from assessment to production in 8 to 12 weeks. Enterprise-wide transformation programs typically run 6 to 12 months, delivered in phased releases so value is realized incrementally.",
  },
  {
    q: "Can you work with our existing legacy systems and vendors?",
    a: "Yes. Most engagements begin by integrating with existing ERP, CRM, and legacy platforms rather than replacing them outright. We assess what should be modernized, what should be wrapped with integration layers, and what should be left untouched.",
  },
  {
    q: "How do you ensure adoption after go-live?",
    a: "Adoption is built into the delivery plan, not left to a training session. We run structured change management, role-based training, and feedback loops so new systems become daily habits rather than shelfware.",
  },
  {
    q: "What does ongoing support look like after transformation?",
    a: "We provide structured post-deployment support including performance monitoring, optimization sprints, and quarterly business reviews, so momentum continues as business conditions evolve.",
  },
];
  ...
  <div className="absolute inset-0 bg-gradient-to-b from-black/30 via-black/50 to-black/80" />
        ...
        <div className="relative max-w-[1200px] mx-auto">
          ...
          <motion.h1 variants={fadeUp} initial="hidden" animate="visible" custom={0.08} className="text-7xl md:text-6xl lg:text-7xl font text-white leading-[1.05]">
            Digital Transformation Built for Enterprise.
          </motion.h1>
  ...
  <div className="max-w-[1400px] mx-auto grid lg:grid-cols-2 gap-20 items-center">
    ...
    >
      ...
      <h2 className="text-5xl font text-black leading-tight mb-8">
        Digital transformation should follow strategy —
        <br />
        not the other way around.
      </h2>

      <p className="text-gray-600 text-lg leading-9 mb-6 font-['montserrat']">
        Most transformation programs begin with a technology decision and
        work backward toward the business case. We reverse that order.
        Every engagement starts with how your organization actually creates
        value, then works forward to the platforms and processes that
        support it.
      </p>

      <p className="text-gray-600 text-lg leading-9">
        Programs built around a vendor's roadmap tend to outlive their
        usefulness. Programs built around your operating model continue to
...
/>
    ...
    >
      ...
      <p className="text-gray-600 text-lg leading-9 mb-6">
        Organizations today have more digital tools than ever, yet teams
        still work around them because processes, data, and platforms
        were never designed to move together.
      </p>

      <p className="text-gray-600 text-lg leading-9">
        Tec Tha treats digital transformation as enterprise infrastructure.
        We build connected processes, governance frameworks, and digital
        platforms that organizations can confidently rely on for
  ...
  <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-[420px_1fr] gap-24">
    ...
    >
      ...
      <p className="mt-8 text-lg leading-8 text-slate-500">
        ...
        starting a digital transformation initiative.
      </p>
  ...
  <div className="relative mx-auto max-w-6xl px-6">
    ...
    <div className=" border border-white/10 bg-gradient-to-br from-white/[0.03] to-white/[0.01] p-14 md:p-20 backdrop-blur-xl">
      ...
      <h2 className="max-w-4xl text-5xl font-light leading-tight text-white md:text-6xl">
        Ready to turn digital ambition
        <br />
        into measurable outcomes?
      </h2>

      <p className="mt-8 max-w-3xl text-lg leading-9 text-white/70">
        Speak with our transformation advisory team to identify where
        strategy, automation, and modernization can create measurable
      ...
      <section className="py-16 px-6 md:px-10 border-t border-white/10 bg-white/[0.02]">
        <div className="max-w-[1200px] mx-auto flex flex-col md:flex-row items-center justify-between gap-6 text-center md:text-left">
          <p className="text-gray-400 text-base max-w-md">
            Explore how Digital Strategy, Process Automation, and Cloud Transformation fit into a single connected roadmap for your organization.
          </p>
