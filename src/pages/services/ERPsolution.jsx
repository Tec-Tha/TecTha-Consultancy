...
/>
  ...
  <div className="absolute inset-0 bg-gradient-to-b from-black/30 via-black/50 to-black/80" />
        ...
        <div className="relative w-full max-w-[1200px] mx-auto">
          <motion.p variants={fadeUp} initial="hidden" animate="visible" custom={0} className="mt-0 md:-mt-20 text-sm sm:text-base md:text-xl font uppercase tracking-[0.15em] sm:tracking-[0.2em] md:tracking-[0.3em] mb-4 md:mb-6 font-['Montserrat'] text-white">
            Enterprise Resource Planning
          </motion.p> <hr className="border-white/40 my-4 md:my-6" />
          <motion.h1 variants={fadeUp} initial="hidden" animate="visible" custom={0.08} className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font text-white leading-[1.1] md:leading-[1.05]">
            ERP Systems Built for Enterprise.
          </motion.h1>
          <motion.p variants={fadeUp} initial="hidden" animate="visible" custom={0.16} className="text-gray-400 text-base sm:text-lg md:text-xl max-w-2xl leading-relaxed mb-6 md:mb-10">
      ...
      {/* Enterprise Vision */}
<section className="py-16 md:py-28 px-4 sm:px-6 md:px-10 bg-white relative overflow-hidden">
  ...
  <div className="max-w-[1400px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-20 items-center">
    ...
    >
      <p className="text-sm uppercase tracking-[0.2em] sm:tracking-[0.3em] text-blue-600 mb-4 md:mb-6 font-semibold">
        Enterprise Vision
      </p>

      <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl font text-black leading-tight mb-6 md:mb-8">
        ERP should mirror your operations —
        <br />
        not force your operations to change.
      </h2>

      <p className="text-gray-600 text-base md:text-lg leading-7 md:leading-9 mb-4 md:mb-6 font-['montserrat']">
  ...
  className="h-[280px] sm:h-[360px] md:h-[500px] lg:h-[650px] w-full rounded-[20px] md:rounded-[32px] object-cover"
/>
...
{/* Business Reality */}
<section className="py-16 md:py-28 px-4 sm:px-6 md:px-10 bg-[#F8FAFC] relative overflow-hidden">
...
/>
    ...
    >
      <p className="text-sm uppercase tracking-[0.2em] sm:tracking-[0.3em] text-blue-600 mb-4 md:mb-6 font">
        Business Reality
      </p>

      <h2 className="text-2xl sm:text-3xl md:text-5xl font text-black leading-tight mb-6 md:mb-8">
        Most enterprises don't have a process problem.
        <br />
        They have a visibility problem.
      </h2>

      <p className="text-gray-600 text-base md:text-lg leading-7 md:leading-9 mb-4 md:mb-6">
...
<section className="py-16 md:py-32 px-4 sm:px-6 md:px-10 bg-black">
  <div className="max-w-[1400px] mx-auto">
    ...
    >
      <p className="text-sm uppercase tracking-[0.2em] sm:tracking-[0.35em] text-blue-500 font-semibold mb-4">
        Executive Challenges
      </p>
    ...
    <div className="space-y-4 md:space-y-6">
      ...
      {CHALLENGES.map((item, index) => (
        ...
        <motion.div
          ...
          className="group relative overflow-hidden rounded-2xl md:rounded-3xl border border-white/10 bg-white/[0.03] backdrop-blur-xl transition-all duration-500 hover:border-blue-500/40 hover:bg-white/[0.06]"
        >

          <div className="grid grid-cols-1 md:grid-cols-[120px_1fr_60px] items-start md:items-center px-5 py-6 sm:px-8 sm:py-8 md:px-10 md:py-10 gap-3 md:gap-8">
            ...
            <div>
              ...
              <h3 className="text-xl sm:text-2xl md:text-3xl text-white font-medium mb-2 md:mb-3">
                {item.title}
              </h3>

              <p className="text-gray-400 text-base md:text-lg leading-6 md:leading-8 max-w-4xl">
                {item.desc}
              </p>
  ...
  <div className="mx-auto max-w-7xl px-4 sm:px-6">
    ...
    <p className="uppercase tracking-[0.2em] sm:tracking-[0.35em] text-blue-500 text-sm font-semibold mb-4 md:mb-5">
      Enterprise Capabilities
    </p>

    <h2 className="text-3xl sm:text-4xl md:text-5xl text-black font-light mb-8 md:mb-16">
      Six disciplines, one connected practice.
    </h2>

    <div className="group/cards flex gap-4 sm:gap-5 md:gap-7 overflow-x-auto overflow-y-hidden snap-x snap-mandatory scroll-smooth pb-6 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
        ...
        >
          ...
          >
            ...
            <div className="absolute bottom-0 p-5 sm:p-6 md:p-8 text-white">
              ...
              <h3 className="text-2xl sm:text-3xl md:text-4xl mb-3 md:mb-4">
                {service.title}
              </h3>
              ...
              <div className="mt-6 md:mt-8 flex items-center gap-2 font-semibold text-sm sm:text-base">
                Explore Service
  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6">
    ...
    <p className="uppercase tracking-[0.2em] sm:tracking-[0.35em] text-blue-600 text-sm font-semibold mb-4 md:mb-5">
      Industry Solutions
    </p>

    <h2 className="text-3xl sm:text-4xl md:text-5xl font-light text-slate-900 max-w-3xl mb-10 md:mb-20">
      Context matters. We build for your industry's constraints.
    </h2>

    <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-x-6 md:gap-x-10 gap-y-10 md:gap-y-20">
      ...
      {INDUSTRIES.map((industry, index) => (
        ...
        >
          ...
          <h3 className="mt-5 md:mt-8 text-2xl sm:text-3xl md:text-4xl font-light text-slate-900">
            {industry.title}
          </h3>

          <p className="mt-3 md:mt-5 text-base md:text-lg leading-7 md:leading-9 text-slate-600">
            {industry.desc}
          </p>
  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6">
    ...
    <h2 className="text-3xl sm:text-4xl md:text-5xl font-light text-white max-w-3xl mb-10 md:mb-24">
    ...
    <div className="space-y-14 md:space-y-32">
      ...
      {METHODOLOGY.map((item, index) => (
        ...
        <motion.div
          ...
          className="border-b border-white/10 pb-10 md:pb-24"
        >
          ...
          <div className="overflow-hidden">
            ...
            <img
              src={item.image}
              alt={item.title}
              className="h-[220px] sm:h-[300px] md:h-[420px] lg:h-[520px] w-full object-cover transition duration-700 hover:scale-105"
            />
          ...
          <div className="mt-6 md:mt-12">
            ...
            <span className="text-[44px] sm:text-[60px] md:text-[90px] font-bold text-white/10">
              {item.step}
            </span>

            <h3 className="mt-2 md:mt-3 text-3xl sm:text-4xl md:text-5xl font-light text-white">
              {item.title}
            </h3>

            <p className="mt-4 md:mt-8 max-w-3xl text-base md:text-lg leading-7 md:leading-9 text-white/70">
              {item.desc}
            </p>
  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 grid grid-cols-1 lg:grid-cols-[420px_1fr] gap-10 lg:gap-24">
    ...
    >
      ...
      <p className="mt-4 md:mt-8 text-base md:text-lg leading-7 md:leading-8 text-slate-500">
      ...
      {FAQS.map((faq, index) => (
        ...
        >
          ...
          <button
            ...
            className="w-full flex justify-between items-start gap-4 md:gap-10 text-left group"
          >

            <div className="flex gap-4 md:gap-8">

              <span className="text-blue-600 font-semibold text-base md:text-lg w-6 md:w-8 shrink-0">
          ...
          >
            ...
            <div className="pl-10 sm:pl-12 md:pl-16 pr-2 sm:pr-6 md:pr-8 pt-4 md:pt-6">

              <p className="text-slate-600 leading-7 md:leading-9 text-base md:text-lg max-w-3xl">
                {faq.a}
              </p>
  ...
  <div className="relative mx-auto max-w-6xl px-4 sm:px-6">
    ...
    <div className="border border-white/10 bg-gradient-to-br from-white/[0.03] to-white/[0.01] p-6 sm:p-8 md:p-14 lg:p-20 backdrop-blur-xl">

      <p className="mb-4 md:mb-5 uppercase tracking-[0.2em] sm:tracking-[0.35em] text-sm font-semibold text-blue-500">
        ERP Advisory
      </p>

      <h2 className="max-w-4xl text-2xl sm:text-3xl md:text-5xl lg:text-6xl font-light leading-tight text-white">
        Ready to turn fragmented operations
        <br />
        into one connected system?
      </h2>

      <p className="mt-5 md:mt-8 max-w-3xl text-base md:text-lg leading-7 md:leading-9 text-white/70">
      ...
      <div className="mt-8 md:mt-12 flex flex-wrap gap-4 md:gap-6">
        ...
        <Link
          to="/contact"
          className="inline-flex items-center gap-3 rounded-full bg-white px-6 py-3 md:px-8 md:py-4 text-sm sm:text-base font-semibold text-black transition-all duration-300 hover:scale-105 hover:bg-slate-100"
        >
        ...
        <Link
          to="/services"
          className="inline-flex items-center gap-3 rounded-full border border-white/20 px-6 py-3 md:px-8 md:py-4 text-sm sm:text-base font-medium text-white transition-all duration-300 hover:border-blue-500 hover:bg-white/5"
        >
          Explore Services
        </Link>
      ...
      {/* Footer CTA */}
      <section className="py-10 md:py-16 px-4 sm:px-6 md:px-10 border-t border-white/10 bg-white/[0.02]">
        <div className="max-w-[1200px] mx-auto flex flex-col md:flex-row items-center justify-between gap-4 md:gap-6 text-center md:text-left">
          ...
          <Link to="/services" className="inline-flex items-center gap-2 rounded-full border border-white/20 px-5 py-3 md:px-6 text-sm font-semibold text-white hover:bg-white/5 transition-colors shrink-0">
            View all services
