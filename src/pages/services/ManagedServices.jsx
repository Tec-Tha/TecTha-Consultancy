...
/>
  ...
  <div className="absolute inset-0 bg-gradient-to-b from-black/30 via-black/50 to-black/80" />
        ...
        <div className="relative w-full max-w-[1200px] mx-auto">
          <motion.p variants={fadeUp} initial="hidden" animate="visible" custom={0} className="-mt-10 sm:-mt-14 md:-mt-20 text-base sm:text-lg md:text-xl font uppercase tracking-[0.2em] sm:tracking-[0.3em] mb-4 sm:mb-6 font-['Montserrat'] text-white">
            Managed Services
          </motion.p> <hr className="border-white/40 my-4 sm:my-6" />
          <motion.h1 variants={fadeUp} initial="hidden" animate="visible" custom={0.08} className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font text-white leading-[1.1] sm:leading-[1.05]">
...
<section className="py-14 sm:py-20 md:py-28 px-4 sm:px-6 md:px-10 bg-white relative overflow-hidden">
  ...
  <div className="max-w-[1400px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-14 lg:gap-20 items-center">
  ...
  className="h-[280px] sm:h-[380px] md:h-[500px] lg:h-[650px] w-full rounded-[20px] sm:rounded-[28px] lg:rounded-[32px] object-cover"
/>
...
<section className="py-16 sm:py-24 md:py-32 px-4 sm:px-6 md:px-10 bg-black">
    ...
    <div className="space-y-4 sm:space-y-5 md:space-y-6">
      ...
      {CHALLENGES.map((item, index) => (
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-[120px_1fr_60px] items-start md:items-center px-5 py-6 sm:px-7 sm:py-8 md:px-10 md:py-10 gap-3 md:gap-8">
            ...
            <div>
              ...
              <p className="text-gray-400 text-base sm:text-lg leading-7 sm:leading-8 max-w-4xl">
                {item.desc}
              </p>
    ...
    <div className="group/cards flex gap-4 sm:gap-5 md:gap-7 overflow-x-auto overflow-y-hidden snap-x snap-mandatory scroll-smooth pb-6 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
      ...
      {CAPABILITIES.map((service, i) => (
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          custom={i * 0.08}
          className="min-w-[78%] xs:min-w-[70%] sm:min-w-[330px] flex-shrink-0 snap-start lg:min-w-[32%]"
        >

          <Link
            to={service.link}
            className="group relative block h-[420px] sm:h-[500px] md:h-[600px] lg:h-[650px] overflow-hidden transition-all duration-700 hover:scale-105"
          >
            ...
            <div className="absolute bottom-0 p-5 sm:p-6 md:p-8 text-white">
              ...
              <div className="mt-6 sm:mt-7 md:mt-8 flex items-center gap-2 font-semibold text-sm sm:text-base">
                Explore Service
  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6">
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-x-6 md:gap-x-10 gap-y-10 sm:gap-y-14 md:gap-y-20">
      ...
      {METHODOLOGY.map((item, index) => (
        ...
        >
          ...
          <div className="mt-6 sm:mt-8 md:mt-12">
            ...
            <span className="text-[48px] sm:text-[64px] md:text-[75px] lg:text-[90px] font-bold text-white/10">
              {item.step}
            </span>
  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 grid grid-cols-1 lg:grid-cols-[420px_1fr] gap-10 md:gap-16 lg:gap-24">
    ...
    >
      ...
      <p className="mt-4 sm:mt-6 md:mt-8 text-base sm:text-lg leading-7 sm:leading-8 text-slate-500">
    ...
    >
      ...
      {FAQS.map((faq, index) => (
        ...
        <div
          key={faq.q}
          className="border-b border-slate-200 py-5 sm:py-6 md:py-8"
        >
          ...
          >
            ...
            <div className="pl-10 sm:pl-12 md:pl-16 pr-2 sm:pr-6 md:pr-8 pt-4 sm:pt-5 md:pt-6">
  ...
  <div className="relative mx-auto max-w-6xl px-4 sm:px-6">
    ...
    <div className=" border border-white/10 bg-gradient-to-br from-white/[0.03] to-white/[0.01] p-6 sm:p-10 md:p-14 lg:p-20 backdrop-blur-xl">
      ...
      <div className="mt-6 sm:mt-8 md:mt-12 flex flex-col xs:flex-row flex-wrap gap-4 sm:gap-6">

        <Link
          to="/contact"
          className="inline-flex items-center justify-center gap-3 rounded-full bg-white px-6 py-3 sm:px-8 sm:py-4 text-sm sm:text-base font-semibold text-black transition-all duration-300 hover:scale-105 hover:bg-slate-100"
        >
        ...
        <Link
          to="/services"
          className="inline-flex items-center justify-center gap-3 rounded-full border border-white/20 px-6 py-3 sm:px-8 sm:py-4 text-sm sm:text-base font-medium text-white transition-all duration-300 hover:border-blue-500 hover:bg-white/5"
        >
          Explore Services
        </Link>
      ...
      {/* Footer CTA */}
      <section className="py-10 sm:py-16 px-4 sm:px-6 md:px-10 border-t border-white/10 bg-white/[0.02]">
        <div className="max-w-[1200px] mx-auto flex flex-col md:flex-row items-center justify-between gap-4 sm:gap-6 text-center md:text-left">
          ...
          <Link to="/services" className="inline-flex items-center gap-2 rounded-full border border-white/20 px-5 py-2.5 sm:px-6 sm:py-3 text-sm font-semibold text-white hover:bg-white/5 transition-colors shrink-0 w-full sm:w-auto justify-center">
            View all services
