      ...
      <section className="relative min-h-[560px] sm:min-h-[640px] md:h-screen md:min-h-[720px] w-full overflow-hidden flex items-end">
        ...
        <div className="relative z-10 w-full max-w-[1400px] mx-auto px-5 sm:px-6 md:px-10 pb-14 sm:pb-16 md:pb-24 pt-24 sm:pt-28 md:pt-40">
          ...
          <motion.h1
            ...
            animate="visible"
            custom={0.12}
            className="text-white text-2xl sm:text-3xl md:text-5xl lg:text-6xl font-light leading-[1.15] sm:leading-[1.08] md:leading-[1.03] max-w-full sm:max-w-md md:max-w-4xl mb-5 sm:mb-8 tracking-tight"
          >
