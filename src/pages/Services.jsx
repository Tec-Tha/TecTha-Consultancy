...
const PROCESS = [
  {
    ...
    title: "Discover",
    description:
      "Analyze business processes, application requirements, and technical challenges to define the right solution.",
    deliverables: [
  ...
  },
  {
    ...
    title: "Architect",
    description:
      "Design scalable enterprise application architectures with secure integrations and future-ready technologies.",
    deliverables: [
      "Solution Design",
  ...
  },
  {
    ...
    title: "Build",
    description:
      "Develop enterprise-grade applications using agile methodologies, quality assurance, and seamless integrations.",
    deliverables: [
  ...
  },
  {
    ...
    title: "Launch",
    description:
      "Deploy enterprise applications with monitoring, optimization, and continuous support for long-term success.",
    deliverables: [
      "Deployment",
